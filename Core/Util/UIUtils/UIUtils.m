...
+ (void)openApp:(NSString*)appId
{
	NSString* iTunesLink = [NSString stringWithFormat:
							@"http://phobos.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=%@&mt=8", appId];
    http://phobos.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=557072001&mt=8
...
//+ (UIViewController)addViewController:(NSObject*)viewController title:(NSString*)title image:(NSString*)image hasNavControlller:(BOOL)hasNavController viewControllers:(NSMutableArray*)viewControllers
//{
//    UIViewController* retViewController = (UIViewController*)[viewController autorelease];
//    UITabBarItem* item = [[[UITabBarItem alloc] initWithTitle:title image:image tag:0] autorelease];
//}
